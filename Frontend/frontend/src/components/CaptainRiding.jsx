...
import FinishRidepop from './FinishRidepop'
    ...
    return (
        <div className='h-screen  relative'>
            ...
            <div className='h-1/5  p-6 bg-yellow-400 flex items-center justify-between relative ' onClick={() => {
                ...
                <h5 className='p-1 text-center w-[90%]   text-2xl absolute top-0'>
                    <i class="ri-arrow-up-s-line"></i>
                </h5>
                <h4 className='text-xl font-semibold  '> 5km Away</h4>
                <button className='bg-green-600 text-white font-semibold p-3 px-10 rounded-lg'> confirm</button>
            </div>



            <div ref={finishRideRef} className="fixed w-full    mb-1 z-10 translate-y-full bottom-0 bg-white p-12">
                <FinishRidepop setfinishRide={setfinishRide} />
