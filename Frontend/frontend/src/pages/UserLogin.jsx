    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                const data = response.data                // Store user data in both context and localStorage
                setuser(data.user)
