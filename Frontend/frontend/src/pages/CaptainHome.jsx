...
<div className="flex justify-between items-center px-6 py-4 bg-white shadow rounded-lg">
        <div className="flex items-center gap-4">
          <img className="h-14 w-14 rounded-full object-cover border-2 border-gray-300" 
               src="https://img.freepik.com/free-photo/front-view-smiley-woman-with-earbuds_23-2148613052.jpg" alt="Profile" />
          <h3 className="text-lg font-semibold text-gray-800">Hariya Singh</h3>
        </div>
