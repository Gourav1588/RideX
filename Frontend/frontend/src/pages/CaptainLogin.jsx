...
> Login</button>
  ...
  <Link to='/captain-signup' className='text-blue-600'> Register as a Captain</Link>
        ...
        <Link to='/login' className='bg-[#d5622d] flex items-center justify-center text-white   font-semibold mb-7 rounded px-4 py-2 border w-full text-lg placeholder:text-base'>  Sign in as user </Link>
      </div>
    </div>
